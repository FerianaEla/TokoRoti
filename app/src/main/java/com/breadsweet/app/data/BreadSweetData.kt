...
object BreadSweetData {
    ...
    val INITIAL_PRODUCTS = listOf(
        ...
        Product(
            ...
            category = "Savory Bread",
            variants = listOf("Smoked Beef Cheese"),
            price = 19000.0,
        ...
        Product(
            ...
            category = "Pastry & Croissant",
            variants = listOf("Double Chocolate"),
            price = 24000.0,
        ...
        Product(
            ...
            name = "Puff Pastry",
            category = "Pastry & Croissant",
            variants = listOf("Apple Pie Slice"),
            price = 18000.0,
        ...
        Product(
            ...
            name = "Cupcake",
            category = "Cakes",
            variants = listOf("Vanila Cokelat"),
            price = 12000.0,
        ...
        Product(
            ...
            name = "Matcha Crepe",
            category = "Cakes",
            variants = listOf("Kyoto Green Tea"),
            price = 30000.0,
